...
from app.modules.provider.dependencies import get_provider_repository
...
def get_contact_service(
    ...
    CustomerProfileRepository`, `provider.ProviderRepository`, `search.
    SearchRequestRepository`, and `notification.NotificationService` as
    cross-module, constructor-injected dependencies, mirroring
    `search.SearchRequestService`'s own multi-module wiring shape.
    """
