"""
Mobile OTP registration/login orchestration (AUTH-001).

Coordinates OTP verification with find-or-create User semantics and JWT
issuance. Deliberately does not touch `customer_profiles`/
`customer_preferences` (AC12 — Customer domain, CUS-001) or
`devices`/`sessions` (AUTH-003).
"""
