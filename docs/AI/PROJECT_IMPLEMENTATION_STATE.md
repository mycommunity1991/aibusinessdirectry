...
See `docs/implementation/walkthroughs/Walkthrough_S10_LEAD-001.md` for the full account. **Sprint 10 is now 1 of
2 stories done — `LEAD-002` ("understand my listing visibility") remains, not yet planned or started, gated on
